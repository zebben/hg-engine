...
u16 sVioletCityMart[] = {
    ITEM_NET_BALL, ITEM_NAUGHTY_MINT, ITEM_MILD_MINT, ITEM_LONELY_MINT, 
    ITEM_RASH_MINT, ITEM_TM131, ITEM_TM134, ITEM_TM135, 0xFFFF
};
...
u16 sGoldenrodDepartment3F[] = {
    ITEM_EXP_SHARE, ITEM_FLAME_ORB, ITEM_TOXIC_ORB, ITEM_BLACK_SLUDGE, ITEM_AIR_BALLOON, ITEM_LIGHT_CLAY, ITEM_EJECT_BUTTON, ITEM_EVIOLITE, 0xFFFF
};
...
u16 sGoldenrodDepartment5F[] = {
    ...
    ITEM_TM014, ITEM_TM015, ITEM_TM094, ITEM_TM099, ITEM_TM016, 
    ITEM_TM106, ITEM_TM119, ITEM_TM136, ITEM_TM142, ITEM_TM151,
    ITEM_TM154, ITEM_TM156, 0xFFFF
};
...
u16 sVermilionAndSafariMart[] = {
    ITEM_DUSK_BALL, ITEM_TM096, ITEM_TM122, ITEM_TM123, ITEM_TM124, ITEM_TM125, 0xFFFF
};
