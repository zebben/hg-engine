...
evodata SPECIES_CHIKORITA
    evolution EVO_LEVEL, 6, SPECIES_CHARIZARD
    evolution EVO_NONE, 0, SPECIES_NONE
    evolution EVO_NONE, 0, SPECIES_NONE
    evolution EVO_NONE, 0, SPECIES_NONE
    evolution EVO_NONE, 0, SPECIES_NONE
...
evodata SPECIES_SLOWPOKE_GALARIAN
    evolution EVO_STONE, ITEM_WATER_STONE, SPECIES_SLOWBRO, 1
    evolution EVO_ITEM_DAY, ITEM_KINGS_ROCK, SPECIES_SLOWKING, 1
    evolution EVO_ITEM_NIGHT, ITEM_KINGS_ROCK, SPECIES_SLOWKING, 1
    evolution EVO_NONE, 0, SPECIES_NONE
    evolution EVO_NONE, 0, SPECIES_NONE
    evolution EVO_NONE, 0, SPECIES_NONE
    evolution EVO_NONE, 0, SPECIES_NONE
