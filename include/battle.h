...
// Check if current move is a spread move (hits multiple targets in doubles)
...
struct BattleStruct {
    ...
    /*...*/
               ...
               u8 simultaneousDamageTargets[CLIENT_MAX]; // Bitmask: which targets need HP updates for simultaneous damage
               u8 simultaneousDamagePhase;               // 0=collect, 1=apply, 2=animate, 3=triggers
               u8 simultaneousDamageTargetCount;         // Number of targets hit by spread move
